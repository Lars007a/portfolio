    ...
    <>
      <div className={styles.intro} id={id}>
        ...
        <div className={styles.dual}>
          <div>
            <p>
              ...
              Medieskolerne, hvor jeg har udviklet både tekniske færdigheder,
              samt en dyb forståelse for webdesign.
            </p>
          </div>
        ...
        <p>
          ...
          projekter, og ser frem til at samarbejde med jer på fremtidige
